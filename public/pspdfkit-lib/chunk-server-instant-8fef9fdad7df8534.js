            ...
            class F {
                ...
                sendRequest(e, t) {
                    return new Promise((s, i) => {
                        if (!this.isAuthenticated || !this.socket)
                            return void i(new a.p2('Cannot send request when the connection is not authenticated'));
                        const n = this.nextRequestId(),
                            o = JSON.stringify(t);
                        this.requestsWaitingForAnswers = this.requestsWaitingForAnswers.set(n, { resolve: s, reject: i });
                ...
                onMessage(e) {
                    ...
                    if (this.isAuthenticated) {
                        ...
                        if (e.requestId) {
                            const t = e.requestId;
                            (0, k.k)(this.requestsWaitingForAnswers.has(t), 'Received a reply with an unknown request ID.');
                ...
                onHello(e) {
                    ...
                    if (2 === e.protocol_version) {
                        const e = { protocol_version: 2, client_version: f, client_info: b, auth_payload: this.authPayload };
            ...
            class w {
                                ...
                                this.setState(
                                    (function (e, t) {
                                        return (
                                            ...
                                            e.withMutations((s) => {
                                                var i;
                                                const n = (0, o.D5)(t.clients.map((e) => v(e)).map((e) => [e.clientId, e])).set(
                ...
                onInfoClientPresence(e) {
                    if (
                                ...
                                const s = e.clients.withMutations((s) => {
                                    ...
                                    if (t.clients.left)
                                        for (const i of t.clients.left) {
                                            if (!e.clients.has(i)) throw new a.p2('The client marked as left is not known');
                                            s.delete(i);
                                        }
                                });
                        ...
                        let i = (0, o.aV)();
                        e.clients.updated && (i = (0, o.aV)(e.clients.left)), this.clientUpdatesCallback(t, s, i);
                    }
                }
                disconnect() {
                ...
                updatePresence(e) {
                    return new Promise((t, s) => {
                        if ('online' !== this.getStatus()) return s(new a.p2('ClientsPresence is not connected'));
            ...
            class P {
                ...
                updateRecord(e, t, s, i) {
                    return new Promise((n, o) => {
                        ...
                        const r = new R({ id: e, content: t, group: s, type: 'updated', isAnonymous: i, resolve: n, reject: o });
                        this.enqueueChangeRequest(r);
                    });
                }
                deleteRecord(e) {
                ...
                enqueueChangeRequest(e) {
                    const t = (0, I.n)({ oldChanges: this._state.localRecordsChanges, newChanges: (0, o.aV)([e]) });
            ...
            class X {
                ...
                createAnnotation(e, t) {
                    const s = (0, r.Hs)(e),
                        ...
                        d = (0, i.Z)(o, $);
                    return (0, a.kG)(n, 'Annotation id must be defined.'), this._sync.createRecord(n, d, (0, r.Lw)(t), c);
                }
                createComment(e) {
                ...
                async updateRecord(e) {
                    var t, s, n;
                    const o = 'pspdfkit/comment' === e.type ? e : Y(Y({}, e), {}, { isAnonymous: void 0 }),
                        { id: r, permissions: c, isAnonymous: l, group: d } = o,
                        h = (0, i.Z)(o, N);
                    return (
                        (0, a.kG)(r, 'Record id must be defined.'),
                        ...
                        n.isCollaborationPermissionsEnabled()
                            ? ((0, a.kG)(c, 'Permissions must be defined.'),
                              this._sync.updateRecord(
                                  r,
                                  c.edit ? h : void 0,
                                  c.setGroup && null != d ? d : void 0,
                                  null != l ? l : void 0,
                              ))
                            : this._sync.updateRecord(r, h, null != d ? d : void 0, null != l ? l : void 0)
                    );
                }
                ...
                createBookmark(e) {
                    const t = (0, c.a)(e),
                        { id: s } = t,
                        n = (0, i.Z)(t, K);
                    return (this._existingBookmarksIds = this._existingBookmarksIds.add(s)), this._sync.createRecord(s, n, {});
                }
                ...
                createFormField(e) {
                    const t = (0, r.vD)(e),
                        ...
                        a = (0, i.Z)(t, J);
                    return (
                        (this._existingFormFieldsIds = this._existingFormFieldsIds.add(o)), this._sync.createRecord(o, a, {}, s)
                    );
                }
                ...
                async setFormFieldValue(e) {
                    const t = (0, r.kr)(e);
                    try {
                        await this._sync.updateRecord((0, q.X)(e), t);
                    } catch (e) {
                        if (!(e instanceof a.p2)) throw e;
                    }
                }
                ...
                _onRecordsUpdates(e, t, s, i) {
                    ...
                    l.length > 0 &&
                        ...
                        _ && !F
                            ? this._formFieldCallbacks.createFormFields((0, o.aV)(l.filter((e) => !(e instanceof z.Yo))), i)
                        ...
                        h.size > 0 && ((0, a.kG)(this._commentCallbacks), this._commentCallbacks.createComments(h, i)),
                        n.size > 0 && ((0, a.kG)(this._bookmarkCallbacks), this._bookmarkCallbacks.createBookmarks(n, i));
                    ...
                    x.size > 0 && ((0, a.kG)(this._annotationCallbacks), this._annotationCallbacks.updateAnnotations(x)),
                        v.size > 0 && ((0, a.kG)(this._bookmarkCallbacks), this._bookmarkCallbacks.updateBookmarks(v)),
                        w.length > 0 &&
                            ((0, a.kG)(this._formFieldCallbacks), this._formFieldCallbacks.updateFormFields((0, o.aV)(w))),
                        I.length > 0 &&
                            ((0, a.kG)(this._formFieldValueCallbacks),
                            this._formFieldValueCallbacks.setFormFieldValues((0, o.aV)(I))),
                        R.length > 0 && ((0, a.kG)(this._commentCallbacks), this._commentCallbacks.updateComments((0, o.aV)(R))),
                        (u = u.concat(
                            b
                                .filter(
                                    (e) =>
                        ...
                        u.size > 0 && ((0, a.kG)(this._annotationCallbacks), this._annotationCallbacks.deleteAnnotations(u)),
                        (m = m.concat(
                            b
                                .filter((e) => {
                        ...
                        m.size > 0 && ((0, a.kG)(this._bookmarkCallbacks), this._bookmarkCallbacks.deleteBookmarks(m)),
                        (p = p.concat(
                            b
                                .filter((e) => {
                        ...
                        p.size > 0 && ((0, a.kG)(this._formFieldCallbacks), this._formFieldCallbacks.deleteFormFields(p)),
                        (k = k.concat(
                            b
                                .filter((e) => {
                                    const t = this._existingFormFieldValuesIds.has(e);
                                    return (
                                        t && (this._existingFormFieldValuesIds = this._existingFormFieldValuesIds.delete(e)), t
                                    );
                                })
                                .toSet(),
                        )),
                        k.size > 0 &&
                            ((0, a.kG)(this._formFieldValueCallbacks), this._formFieldValueCallbacks.deleteFormFieldValues(k)),
                        (f = f.concat(
                            b
                                .filter((e) => {
                        ...
                        f.size > 0 && ((0, a.kG)(this._commentCallbacks), this._commentCallbacks.deleteComments(f));
                }
                        ...
                        if (o && 'string' != typeof o) {
                            ...
                            (o = o.merge(e)),
                                o instanceof T.Z
                                    ...
                                    : o instanceof D.ZP && (t.permissions && t.permissions.view ? r.push(o) : d.push(o.id));
                        }
                    }
                    e.isEmpty() || e.forEach(h),
                        t.isEmpty() || t.forEach(h),
                        i.length > 0 &&
                            ((0, a.kG)(this._annotationCallbacks), this._annotationCallbacks.updateAnnotations((0, o.aV)(i), !0)),
                        n.length > 0 && ((0, a.kG)(this._commentCallbacks), this._commentCallbacks.updateComments((0, o.aV)(n))),
                        r.length > 0 &&
                            ((0, a.kG)(this._formFieldCallbacks), this._formFieldCallbacks.updateFormFields((0, o.aV)(r))),
                        c.length > 0 &&
                            ((0, a.kG)(this._annotationCallbacks), this._annotationCallbacks.deleteAnnotations((0, o.l4)(c), !0)),
                        l.length > 0 && ((0, a.kG)(this._commentCallbacks), this._commentCallbacks.deleteComments((0, o.l4)(l))),
                        d.length > 0 &&
                            ((0, a.kG)(this._formFieldCallbacks), this._formFieldCallbacks.deleteFormFields((0, o.l4)(d)));
                }
                onClientsChange(e) {
                    if ('function' != typeof e) throw new TypeError('Callback must be a function');
