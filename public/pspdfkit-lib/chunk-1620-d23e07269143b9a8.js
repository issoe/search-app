...
(self.webpackChunkPSPDFKit = self.webpackChunkPSPDFKit || []).push([
    [1620],
    {
        46309: (e, t, i) => {
            ...
            class u {
                constructor() {
                    (0, n.Z)(this, 'attachmentsCache', (0, r.D5)()),
                        (0, n.Z)(this, 'cachedAPStreams', (0, r.D5)()),
                        (0, n.Z)(this, 'pageAPStreamsPromises', (0, r.D5)()),
                        (0, n.Z)(this, 'annotationAPStreamPromises', (0, r.D5)());
                }
                getAnnotationFormFieldAndValue(e) {
                    var t;
                    const i = this.provider;
                    (0, s.kG)(i instanceof i.constructor, 'Backend can only use backend annotation provider');
                    const n =
                        e instanceof a.x_
                            ? null === (t = i._readStateCallbacks) || void 0 === t
                                ? void 0
                ...
                getAnnotationAvailableVariants(e) {
                    ...
                    (0, s.kG)(i instanceof i.constructor, 'Backend can only use backend annotation provider');
                    return [
                        ...((null === (t = i._readStateCallbacks) || void 0 === t ? void 0 : t.getAvailableVariants(e)) || []),
                        'normal',
                    ];
                }
                cachedRenderAnnotation(e, t, i, n, r) {
                    const a = this.provider;
                    (0, s.kG)(a instanceof a.constructor, 'Backend can only use backend annotation provider');
                    const { formField: c, formFieldValue: l } = this.getAnnotationFormFieldAndValue(e);
                    if (!(0, o._R)(e, c)) return this.renderAnnotation(e, l, t, i, n, r);
                    const u = this.getAnnotationAvailableVariants(e);
                    let d = !1,
                        m = () => {
                            d = !0;
                        };
                    return {
                        promise: new Promise(async (s, a) => {
                            const o = (t) => {
                            ...
                            (this.annotationAPStreamPromises = this.annotationAPStreamPromises.set(e.id, s)), c && c(null);
                            try {
                                const a = this.pageAPStreamsPromises.get(e.pageIndex);
                                if (!a) {
                                ...
                                if (c) {
                                    ...
                                    if (t) return void o(this.getAPStream(t, r));
                                }
                                const { promise: f, cancel: p } = this.renderAPStream(e, l, t, i, n, u, r);
                                if (d) o(null);
                                else if (((m = p), u.length > 1)) {
                                    const t = await Promise.all(f.map((e) => e.promise));
                                    o(t[u.indexOf(r || 'normal')]),
                                        t.some(Boolean) &&
                                            this.cacheAPStream(
                                                u.reduce((e, i, n) => h(h({}, e), {}, { [i]: t[n] }), {}),
                                                e,
                                            );
                                } else {
                                    const t = await f,
                                        i = t ? this.getAPStream(t, r) : null;
                ...
                renderAPStream(e, t, i, n, r, s, a) {
                    if (s.length > 1) {
                        const a = s.map((s) => this.renderAnnotation(e, t, i, n, r, 'normal' !== s ? s : void 0));
                        return {
                            promise: a,
                            cancel: () => {
                                a.forEach((e) => {
                    ...
                    return this.renderAnnotation(e, t, i, n, r, a);
                }
                releaseAPStream(e) {
                    e instanceof c.Z
                        ? e.release()
        ...
        45207: (e, t, i) => {
            ...
            class a {
                constructor(e) {
                    (this.queue = (0, n.zN)()),
                        (this.priorityQueue = (0, n.zN)()),
                        (this.inFlightRequests = (0, n.D5)()),
                ...
                enqueue(e) {
                    ...
                    const s = new Promise((e, t) => {
                        ...
                        a = t ? this.priorityQueue : this.queue,
                        o = (0, n.t8)(a, e, { promise: s, resolve: i, reject: r });
                    return (
                        t ? (this.priorityQueue = o) : (this.queue = o),
                        t ? this.next() : setTimeout(() => this.next(), 35),
                        { promise: s, cancel: () => this._cancel(e) }
                    );
                }
                _cancel(e) {
                ...
                cancelAll() {
                    (this.queue = (0, n.zN)()), (this.priorityQueue = (0, n.zN)()), (this.inFlightRequests = (0, n.D5)());
                }
                ...
                next() {
                    if (!(this.isDestroyed || this.inFlightRequests.size >= this.inflightRequestLimit)) {
                        if (this.priorityQueue.size >= 1) {
                            const e = this.priorityQueue.findLastEntry(s);
                            (0, r.k)(e);
                            const [t, i] = e;
                            return (
                        ...
                        if (this.queue.size >= 1) {
                            const e = this.queue.findEntry(s);
                            (0, r.k)(e);
                            const [t, i] = e;
        ...
        70569: (e, t, i) => {
            ...
            function a(e, t, i, n, r, a) {
                let o;
                return e.has(i) ? (o = e.get(i)) : ((o = r.toString()), (t[o] = i), e.set(i, o)), s(s({}, n), {}, { [a]: o });
            }
        },
        45513: (e, t, i) => {
            i.d(t, { E: () => o });
                            ...
                            .map(
                                (e) => (
                                    ...
                                    new a.Z({
                                        ...
                                        rectsOnPage: (0, n.aV)(e.rectsOnPage).map((e) => (0, s.k)(e)),
                                        isAnnotation: !!e.isAnnotation,
                                        annotationRect: e.annotationRect ? (0, s.k)(e.annotationRect) : null,
                                    })
                                ),
                            )
                            .filter(Boolean),
