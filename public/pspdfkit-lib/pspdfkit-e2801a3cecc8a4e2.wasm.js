        ...
        function (PSPDFModuleInit) {
            ...
            function createWasm() {
                ...
                function A(g, A) {
                    var I = g.exports;
                    (Module.asm = I),
                        updateGlobalBufferAndViews((wasmMemory = Module.asm.Zc).buffer),
                        (wasmTable = Module.asm.nd),
                        addOnInit(Module.asm._c),
            ...
            var WORKERFS = {
                    ...
                    createNode: function (g, A, I, C, e, t) {
                        ...
                        return (
                            ...
                            I === WORKERFS.FILE_MODE
                                ? ((n.size = e.size), (n.contents = e))
                                : ((n.size = 4096), (n.contents = {})),
                            g && (g.contents[A] = n),
                            n
                        );
                    },
                    ...
                    open: function (g, A, I, C, e) {
                        ...
                        r.stream_ops.open && r.stream_ops.open(r),
                            !Module.logReadFiles ||
                                ...
                                g in FS.readFiles ||
                                    ((FS.readFiles[g] = 1), err('FS.trackingDelegate error on read file: ' + g)));
                        try {
                    ...
                    ensureErrnoError: function () {
                        FS.ErrnoError ||
                            ...
                            [44].forEach(function (g) {
                                (FS.genericErrors[g] = new FS.ErrnoError(g)),
                                    (FS.genericErrors[g].stack = '<generic error, no stack>');
                            }));
                    },
                    staticInit: function () {
                        FS.ensureErrnoError(),
                                    ...
                                    if (
                                        ...
                                        void 0 === i.chunks[g] &&
                                            (i.chunks[g] = (function (g, A) {
                                                if (g > A)
                                                    throw new Error(
                                                        'invalid range (' + g + ', ' + A + ') or no bytes requested!',
                                                    );
                                                if (A > C - 1)
                ...
                SYSCALLS = {
                    ...
                    doAccess: function (g, A) {
                        ...
                        var C = '';
                        return (
                            4 & A && (C += 'r'), 2 & A && (C += 'w'), 1 & A && (C += 'x'), C && FS.nodePermissions(I, C) ? -2 : 0
                        );
                    },
            ...
            function syscallMmap2(g, A, I, C, e, t) {
                var n;
                t <<= 12;
                var i = !1;
                if (0 != (16 & C) && g % 65536 != 0) return -28;
                if (0 != (32 & C)) {
                    if (!(n = mmapAlloc(A))) return -48;
                    i = !0;
                } else {
                    var r = FS.getStream(e);
                    if (!r) return -8;
                    var o = FS.mmap(r, g, A, t, I, C);
                    (n = o.ptr), (i = o.allocated);
                }
                return (SYSCALLS.mappings[n] = { malloc: n, len: A, allocated: i, fd: e, prot: I, flags: C, offset: t }), n;
            }
            function ___sys_mmap2(g, A, I, C, e, t) {
                try {
                    return syscallMmap2(g, A, I, C, e, t);
                } catch (g) {
                    return (void 0 !== FS && g instanceof FS.ErrnoError) || abort(g), -g.errno;
                }
            }
                            ...
                            function (g) {
                                if (this[g] === n[g])
                                    throw new PureVirtualError(
                                        'Pure virtual function ' + g + ' must be implemented in JavaScript',
                                    );
                            }.bind(this),
                        ),
            ...
            function __embind_register_class(g, A, I, C, e, t, n, i, r, o, a, l, c) {
                ...
                exposePublicSymbol(d, function () {
                    ...
                    whenDependentTypesAreResolved([g, A, I], C ? [C] : [], function (A) {
                        ...
                        return (
                            (registeredPointers[g] = { pointerType: u, constPointerType: m }),
                            replacePublicSymbol(d, n),
                            [s, u, m]
                        );
                    });
            }
                    ...
                    whenDependentTypesAreResolved([], [g], function (g) {
                        ...
                        return (
                            ...
                            whenDependentTypesAreResolved([], i, function (g) {
                                ...
                                return (
                                    void 0 === r[A].overloadTable
                                        ? ((i.argCount = I - 1), (r[A] = i))
                                        : (r[A].overloadTable[I - 1] = i),
                                    []
                                );
                            }),
                            []
                    ...
                    whenDependentTypesAreResolved([], [g], function (g) {
                        ...
                        return (
                            ...
                            whenDependentTypesAreResolved([], r, function (e) {
                                ...
                                return (
                                    void 0 === o[A].overloadTable
                                        ? ((i.argCount = I - 2), (o[A] = i))
                                        : (o[A].overloadTable[I - 2] = i),
                                    []
                                );
                            }),
                            []
            ...
            function validateThis(g, A, I) {
                return (
                    g instanceof Object || throwBindingError(I + ' with invalid "this": ' + g),
                    g instanceof A.registeredClass.constructor ||
                        throwBindingError(I + ' incompatible with "this" of type ' + g.constructor.name),
                    g.$$.ptr || throwBindingError('cannot call emscripten binding method ' + I + ' on deleted object'),
                    upcastPointer(g.$$.ptr, g.$$.ptrType.registeredClass, A.registeredClass)
                );
            }
            function __embind_register_class_property(g, A, I, C, e, t, n, i, r, o) {
                (A = readLatin1String(A)),
                    (e = embind__requireFunction(C, e)),
                    whenDependentTypesAreResolved([], [g], function (g) {
                        var C = (g = g[0]).name + '.' + A,
                            a = {
                                get: function () {
                                    throwUnboundTypeError('Cannot access ' + C + ' due to unbound types', [I, n]);
                                },
                                enumerable: !0,
                                configurable: !0,
                            };
                        return (
                            (a.set = r
                                ...
                                : function (g) {
                                      throwBindingError(C + ' is a read-only property');
                                  }),
                            Object.defineProperty(g.registeredClass.instancePrototype, A, a),
                            whenDependentTypesAreResolved([], r ? [I, n] : [I], function (I) {
                                var n = I[0],
                                    a = {
                                        get: function () {
                                            var A = validateThis(this, g, C + ' getter');
                                            return n.fromWireType(e(t, A));
                                        },
                                        enumerable: !0,
                                    };
                                if (r) {
                                    r = embind__requireFunction(i, r);
                                    var l = I[1];
                                    a.set = function (A) {
                                        var I = validateThis(this, g, C + ' setter'),
                                            e = [];
                                        r(o, I, l.toWireType(e, A)), runDestructors(e);
                                    };
                                }
                                return Object.defineProperty(g.registeredClass.instancePrototype, A, a), [];
                            }),
                            []
                        );
                    });
            ...
            function __embind_register_smart_ptr(g, A, I, C, e, t, n, i, r, o, a, l) {
                (I = readLatin1String(I)),
                    (t = embind__requireFunction(e, t)),
                    (i = embind__requireFunction(n, i)),
                    (o = embind__requireFunction(r, o)),
                    (l = embind__requireFunction(a, l)),
                    whenDependentTypesAreResolved([g], [A], function (g) {
                        return (g = g[0]), [new RegisteredPointer(I, g.registeredClass, !1, !1, !0, g, C, t, i, o, l)];
                    });
            }
                    ...
                    toWireType: function (g, A) {
                        ...
                        if (((HEAPU32[t >> 2] = e), I && C)) stringToUTF8(A, t + 4, e + 1);
                            ...
                            for (var n = 0; n < e; ++n) {
                                ...
                                i > 255 &&
                                    (_free(t), throwBindingError('String has UTF-16 code units that do not fit in 8 bits')),
                                    (HEAPU8[t + 4 + n] = i);
                            }
            ...
            function __emval_call(g, A, I, C) {
                g = requireHandle(g);
                for (var e = __emval_lookupTypes(A, I), t = new Array(A), n = 0; n < A; ++n) {
                    var i = e[n];
                    (t[n] = i.readValueFromPointer(C)), (C += i.argPackAdvance);
                }
                return __emval_register(g.apply(void 0, t));
            }
            ...
            function __emval_get_method_caller(g, A) {
                ...
                var o = 'return function ' + makeLegalFunctionName('methodCaller_' + e) + '(handle, name, destructors, args) {\n',
                    a = 0;
                for (r = 0; r < g - 1; ++r)
                ...
                var m = {
                    ...
                    '%j': function (g) {
                        return c(
                            g.tm_mday +
                                __arraySum(
                                    __isLeapYear(g.tm_year + 1900) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR,
                                    g.tm_mon - 1,
                                ),
                            3,
                        );
                    ...
                    '%V': function (g) {
                        ...
                        return d(n, e) < 0
                            ...
                            ? '01'
                            : ((A =
                                  e.getFullYear() < g.tm_year + 1900
                                      ? g.tm_yday + 32 - e.getDate()
                    ...
                    '%z': function (g) {
                        var A = g.tm_gmtoff,
                            I = A >= 0;
                        return (
                            (A = ((A = Math.abs(A) / 60) / 60) * 100 + (A % 60)), (I ? '+' : '-') + String('0000' + A).slice(-4)
                        );
                    },
                    '%Z': function (g) {
                        return g.tm_zone;
            ...
            function _strptime(g, A, I) {
                ...
                if (c) {
                    ...
                    return (
                        ...
                        (HEAP32[(I + 28) >> 2] =
                            __arraySum(
                                __isLeapYear(S.getFullYear()) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR,
                                S.getMonth() - 1,
                            ) +
                            S.getDate() -
                            1),
            ...
            var decodeBase64 =
                ...
                asmLibraryArg = {
                    ...
                    _a: ___cxa_find_matching_catch_6,
                    r: ___cxa_free_exception,
                    Ga: ___cxa_rethrow,
                    Jb: ___cxa_thread_atexit,
                    s: ___cxa_throw,
                    ...
                    La: ___sys_stat64,
                    Ia: ___sys_unlink,
                    Ub: __embind_create_inheriting_constructor,
                    Bc: __embind_finalize_value_object,
                    zc: __embind_register_bigint,
                    Eb: __embind_register_bool,
                    ga: __embind_register_class,
                    Xa: __embind_register_class_class_function,
                    Nb: __embind_register_class_constructor,
                    K: __embind_register_class_function,
                    db: __embind_register_class_property,
                    ...
                    ib: __embind_register_smart_ptr,
                    Ra: __embind_register_std_string,
                    za: __embind_register_std_wstring,
                    Hc: __embind_register_value_object,
                    Ya: __embind_register_value_object_field,
                    Fb: __embind_register_void,
                    fb: __emscripten_throw_longjmp,
                    fa: __emval_as,
                    Xc: __emval_call,
                    X: __emval_call_method,
                    Wa: __emval_call_void_method,
                    Ma: __emval_decref,
                    Pb: __emval_get_global,
                    ...
                    Ec: invoke_iiiiiiiiiiiiii,
                    Dc: invoke_iiiiiiiiiiiiiii,
                    dc: invoke_iiiiij,
                    rc: invoke_iiiij,
                    tc: invoke_iiiiji,
                    Xb: invoke_iiiijj,
                    ...
                    Da: invoke_viff,
                    Z: invoke_viffff,
                    Ic: invoke_viffffffff,
                    Tc: invoke_vifi,
                    ia: invoke_vifii,
                    ja: invoke_vifiiiiiiif,
                    d: invoke_vii,
                    $: invoke_viid,
                    S: invoke_viif,
                    Nc: invoke_viifi,
                    ...
                    Rc: invoke_viiifii,
                    Yc: invoke_viiifiiii,
                    Uc: invoke_viiifiiiiiii,
                    i: invoke_viiii,
                    V: invoke_viiiif,
                    Pc: invoke_viiiifi,
                    Sc: invoke_viiiifii,
                    o: invoke_viiiii,
                    Qc: invoke_viiiiifiiiii,
                    m: invoke_viiiiii,
                    Fa: invoke_viiiiiif,
                    Lc: invoke_viiiiiiffff,
                    A: invoke_viiiiiii,
                    eb: invoke_viiiiiiifiii,
                    F: invoke_viiiiiiii,
                    O: invoke_viiiiiiiii,
                    J: invoke_viiiiiiiiii,
                    la: invoke_viiiiiiiiiii,
                    ca: invoke_viiiiiiiiiiii,
                    Fc: invoke_viiiiiiiiiiiii,
                    ua: invoke_viiiiiiiiiiiiii,
                    ba: invoke_viiiiiiiiiiiiiii,
                    cc: invoke_viiiiiijji,
                    nc: invoke_viiiijii,
                    fc: invoke_viiiijj,
                    ec: invoke_viiij,
                    Zb: invoke_viiiji,
                ...
                ___wasm_call_ctors = (Module.___wasm_call_ctors = function () {
                    return (___wasm_call_ctors = Module.___wasm_call_ctors = Module.asm._c).apply(null, arguments);
                }),
                ...
                _free = (Module._free = function () {
                    return (_free = Module._free = Module.asm.ad).apply(null, arguments);
                }),
                ___errno_location = (Module.___errno_location = function () {
                    return (___errno_location = Module.___errno_location = Module.asm.bd).apply(null, arguments);
                }),
                ___getTypeName = (Module.___getTypeName = function () {
                    return (___getTypeName = Module.___getTypeName = Module.asm.cd).apply(null, arguments);
                }),
                ...
                __get_tzname = (Module.__get_tzname = function () {
                    return (__get_tzname = Module.__get_tzname = Module.asm.ed).apply(null, arguments);
                }),
                __get_daylight = (Module.__get_daylight = function () {
                    return (__get_daylight = Module.__get_daylight = Module.asm.fd).apply(null, arguments);
                }),
                __get_timezone = (Module.__get_timezone = function () {
                    return (__get_timezone = Module.__get_timezone = Module.asm.gd).apply(null, arguments);
                }),
                stackSave = (Module.stackSave = function () {
                    return (stackSave = Module.stackSave = Module.asm.hd).apply(null, arguments);
                }),
                stackRestore = (Module.stackRestore = function () {
                    return (stackRestore = Module.stackRestore = Module.asm.id).apply(null, arguments);
                }),
                _setThrew = (Module._setThrew = function () {
                    return (_setThrew = Module._setThrew = Module.asm.jd).apply(null, arguments);
                }),
                ___cxa_can_catch = (Module.___cxa_can_catch = function () {
                    return (___cxa_can_catch = Module.___cxa_can_catch = Module.asm.kd).apply(null, arguments);
                }),
                ___cxa_is_pointer_type = (Module.___cxa_is_pointer_type = function () {
                    return (___cxa_is_pointer_type = Module.___cxa_is_pointer_type = Module.asm.ld).apply(null, arguments);
                }),
                ...
                dynCall_viijj = (Module.dynCall_viijj = function () {
                    return (dynCall_viijj = Module.dynCall_viijj = Module.asm.od).apply(null, arguments);
                }),
                dynCall_vij = (Module.dynCall_vij = function () {
                    return (dynCall_vij = Module.dynCall_vij = Module.asm.pd).apply(null, arguments);
                }),
                ...
                dynCall_iiij = (Module.dynCall_iiij = function () {
                    return (dynCall_iiij = Module.dynCall_iiij = Module.asm.rd).apply(null, arguments);
                }),
                dynCall_iij = (Module.dynCall_iij = function () {
                    return (dynCall_iij = Module.dynCall_iij = Module.asm.sd).apply(null, arguments);
                }),
                dynCall_iiiiji = (Module.dynCall_iiiiji = function () {
                    return (dynCall_iiiiji = Module.dynCall_iiiiji = Module.asm.td).apply(null, arguments);
                }),
                dynCall_iiiij = (Module.dynCall_iiiij = function () {
                    return (dynCall_iiiij = Module.dynCall_iiiij = Module.asm.ud).apply(null, arguments);
                }),
                dynCall_j = (Module.dynCall_j = function () {
                    return (dynCall_j = Module.dynCall_j = Module.asm.vd).apply(null, arguments);
                }),
                dynCall_iiiiij = (Module.dynCall_iiiiij = function () {
                    return (dynCall_iiiiij = Module.dynCall_iiiiij = Module.asm.wd).apply(null, arguments);
                }),
                dynCall_jji = (Module.dynCall_jji = function () {
                    return (dynCall_jji = Module.dynCall_jji = Module.asm.xd).apply(null, arguments);
                }),
                dynCall_viij = (Module.dynCall_viij = function () {
                    return (dynCall_viij = Module.dynCall_viij = Module.asm.yd).apply(null, arguments);
                }),
                dynCall_iiijj = (Module.dynCall_iiijj = function () {
                    return (dynCall_iiijj = Module.dynCall_iiijj = Module.asm.zd).apply(null, arguments);
                }),
                dynCall_viiiijii = (Module.dynCall_viiiijii = function () {
                    return (dynCall_viiiijii = Module.dynCall_viiiijii = Module.asm.Ad).apply(null, arguments);
                }),
                dynCall_jii = (Module.dynCall_jii = function () {
                    return (dynCall_jii = Module.dynCall_jii = Module.asm.Bd).apply(null, arguments);
                }),
                dynCall_jiii = (Module.dynCall_jiii = function () {
                    return (dynCall_jiii = Module.dynCall_jiii = Module.asm.Cd).apply(null, arguments);
                }),
                dynCall_viijii = (Module.dynCall_viijii = function () {
                    return (dynCall_viijii = Module.dynCall_viijii = Module.asm.Dd).apply(null, arguments);
                }),
                dynCall_viiijj = (Module.dynCall_viiijj = function () {
                    return (dynCall_viiijj = Module.dynCall_viiijj = Module.asm.Ed).apply(null, arguments);
                }),
                dynCall_iiji = (Module.dynCall_iiji = function () {
                    return (dynCall_iiji = Module.dynCall_iiji = Module.asm.Fd).apply(null, arguments);
                }),
                dynCall_jiji = (Module.dynCall_jiji = function () {
                    return (dynCall_jiji = Module.dynCall_jiji = Module.asm.Gd).apply(null, arguments);
                }),
                dynCall_jjii = (Module.dynCall_jjii = function () {
                    return (dynCall_jjii = Module.dynCall_jjii = Module.asm.Hd).apply(null, arguments);
                }),
                dynCall_jjiiiiii = (Module.dynCall_jjiiiiii = function () {
                    return (dynCall_jjiiiiii = Module.dynCall_jjiiiiii = Module.asm.Id).apply(null, arguments);
                }),
                dynCall_viiiijj = (Module.dynCall_viiiijj = function () {
                    return (dynCall_viiiijj = Module.dynCall_viiiijj = Module.asm.Jd).apply(null, arguments);
                }),
                dynCall_iiiijj = (Module.dynCall_iiiijj = function () {
                    return (dynCall_iiiijj = Module.dynCall_iiiijj = Module.asm.Kd).apply(null, arguments);
                }),
                dynCall_viiij = (Module.dynCall_viiij = function () {
                    return (dynCall_viiij = Module.dynCall_viiij = Module.asm.Ld).apply(null, arguments);
                }),
                dynCall_viiiiiijji = (Module.dynCall_viiiiiijji = function () {
                    return (dynCall_viiiiiijji = Module.dynCall_viiiiiijji = Module.asm.Md).apply(null, arguments);
                }),
                dynCall_viiijjj = (Module.dynCall_viiijjj = function () {
                    return (dynCall_viiijjj = Module.dynCall_viiijjj = Module.asm.Nd).apply(null, arguments);
                }),
                dynCall_vijiiii = (Module.dynCall_vijiiii = function () {
                    return (dynCall_vijiiii = Module.dynCall_vijiiii = Module.asm.Od).apply(null, arguments);
                }),
                dynCall_vijiiiii = (Module.dynCall_vijiiiii = function () {
                    return (dynCall_vijiiiii = Module.dynCall_vijiiiii = Module.asm.Pd).apply(null, arguments);
                }),
                dynCall_viiiji = (Module.dynCall_viiiji = function () {
                    return (dynCall_viiiji = Module.dynCall_viiiji = Module.asm.Qd).apply(null, arguments);
                }),
                dynCall_ijiiiii = (Module.dynCall_ijiiiii = function () {
                    return (dynCall_ijiiiii = Module.dynCall_ijiiiii = Module.asm.Rd).apply(null, arguments);
                }),
                dynCall_iji = (Module.dynCall_iji = function () {
                    return (dynCall_iji = Module.dynCall_iji = Module.asm.Sd).apply(null, arguments);
                }),
                dynCall_viijiiii = (Module.dynCall_viijiiii = function () {
                    return (dynCall_viijiiii = Module.dynCall_viijiiii = Module.asm.Td).apply(null, arguments);
                }),
                ...
                dynCall_iiiiijj = (Module.dynCall_iiiiijj = function () {
                    return (dynCall_iiiiijj = Module.dynCall_iiiiijj = Module.asm.Wd).apply(null, arguments);
                }),
                dynCall_iiiiiijj = (Module.dynCall_iiiiiijj = function () {
                    return (dynCall_iiiiiijj = Module.dynCall_iiiiiijj = Module.asm.Xd).apply(null, arguments);
                }),
                calledRun;
            ...
            function invoke_vidii(g, A, I, C, e) {
                var t = stackSave();
                try {
                    wasmTable.get(g)(A, I, C, e);
                } catch (g) {
            ...
            function invoke_iiiff(g, A, I, C, e) {
                var t = stackSave();
                try {
                    return wasmTable.get(g)(A, I, C, e);
                } catch (g) {
            ...
            function invoke_iiijj(g, A, I, C, e, t, n) {
                var i = stackSave();
                try {
                    return dynCall_iiijj(g, A, I, C, e, t, n);
                } catch (g) {
                    if ((stackRestore(i), g !== g + 0 && 'longjmp' !== g)) throw g;
                    _setThrew(1, 0);
                }
