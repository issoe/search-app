                    ...
                    <div className="flex justify-center mb-12 md:mb-0 md:w-9/12 lg:w-5/12 xl:w-5/12">
                        <div className="w-[80%]">
                            ...
                            <div className="text-center lg:text-left">
                                ...
                                {/* <!-- Register link --> */}
                                <div className="mb-0 mt-2 pt-1 text-sm lg:text-right md:text-center font-semibold">
                                    <Link to="/register" className="hover:cursor-pointer hover:underline hover:text-blue-600">
