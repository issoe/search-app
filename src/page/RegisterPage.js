                    ...
                    <div className="g-6 flex w-[80%] h-full flex-wrap items-center justify-center lg:justify-between">
                        ...
                        <div className="flex justify-center mb-12 md:mb-4 md:w-9/12 lg:w-5/12 xl:w-5/12">
                            <div className="w-[80%]">
                                ...
                                {/* <!-- Email input --> */}
                                <div className="w-[100%] mt-6 mb-6 h-10">
                                    <input
                                ...
                                <div className="relative w-[100%] mb-6 h-10">
                                    ...
                                    <div
                                        className="absolute translate-y-[-50%] top-[50%] right-0 mr-2 hover:cursor-pointer"
                                        onClick={() => setHiddenConfirmPassword((prev) => !prev)}
                                    >
                                ...
                                <div className="text-center lg:text-left">
                                    ...
                                    {/* <!-- Register link --> */}
                                    <div className="lg:flex lg:justify-end mb-0 mt-2 pt-1 text-sm md:text-center lg:text-right font-semibold">
                                        <Link to="/login" className="hover:cursor-pointer hover:underline hover:text-blue-600">
